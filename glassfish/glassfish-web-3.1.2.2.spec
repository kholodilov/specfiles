...
getent passwd %{glassfish_user} >/dev/null || /usr/sbin/useradd --comment "Glassfish Daemon User" --shell /bin/bash -M -r -g %{glassfish_group} --home %{glassfish_home} %{glassfish_user}
