...
# 
# wget https://raw.github.com/dartov/specfiles/master/storm-0.8/storm-0.8.1.spec -O ~/rpmbuild/SPECS/storm-0.8.1.spec
# wget https://github.com/downloads/nathanmarz/storm/storm-0.8.1.zip -O ~/rpmbuild/SOURCES/storm-0.8.1.zip
